  ...
  <div class="A">
    ...
    <div class="address">
      ...
      <div>
        ...
        <div class="liu" @click="onclickCKWL(dataInfo.express_number)">
          查看物流
        </div>
    ...
    <div class="delivery">
      <div class="del">
        <p @click="onclickQDSH(dataInfo.id)">确认收货</p>
      </div>
    </div>
  </div>
</template>
