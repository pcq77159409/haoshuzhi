      ...
      <div class="shopbg">
        <div class="shop">
          ...
          <div class="shoptext">
            <div class="shopphoto">
              <img src="../assets/店铺@3x.png" alt="" />
              <p>{{ shoplist.store_name }}</p>
            </div>
            <div class="codenum">
              <p>共有{{ shoplist.numberCount }}个号码</p>
            </div>
          </div>
          <div class="shopcall">
            <img src="../assets/客服@3x.png" alt="" />
            <p>客服</p>
          </div>
        </div>
        <!-- 轮播图部分 -->
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`api/home_page/getLocation?store_id=${this.store_id}`)
      .then((val) => {
        console.log("商户号码", val);
...
.shopbg {
  ...
  overflow: hidden;
  height: 211 / @vw;
  background-image: linear-gradient(#fe5858, #fe5858, #fff);
  .shop {
    display: flex;
    box-sizing: border-box;
    justify-content: space-around;
    align-items: center;
    padding: 0 10 / @vw 0 10 / @vw;
    margin: 10 / @vw auto;
    width: 353.5 / @vw;
    height: 68.5 / @vw;
