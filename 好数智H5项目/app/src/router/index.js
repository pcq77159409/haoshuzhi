...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "home_trill",
        component: () => import("../views/home_trill.vue"),
        children: [
          {
  ...
  },
  {
    ...
    component: () => import("../views/GoAdderss.vue"),
  },
  {
    path: "/screen",
    name: "screen",
  ...
  },
  {
    path: "/couples",
    name: "couples",
    component: () => import("../views/couples.vue"),
  },
  {
    path: "/details",
    name: "details",
  ...
  },
  {
    path: "/khssb",
    name: "khssb",
    component: () => import("../views/khssb.vue"),
  },
  {
    path: "/details_couplesfor",
    name: "details_couplesfor",
    component: () => import("../views/details_couplesfor.vue"),
  },
  {
    path: "/form_orders_path",
    name: "form_orders_path",
    component: () => import("../views/form_orders_path.vue"),
  },
  {
    path: "/form_orders_path_couples",
    name: "form_orders_path_couples",
    component: () => import("../views/form_orders_path_couples.vue"),
  },
  {
    path: "/commerce_payment",
    name: "commerce_payment",
    component: () => import("../views/commerce_payment.vue"),
  },
  {
    path: "/Payload",
    name: "Payload",
  ...
  },
  {
    ...
    component: () => import("../views/Integral_subsidiary.vue"),
  },
  {
    path: "/Purchase",
    name: "Purchase",
  ...
  },
  {
    path: "/apply_for",
    name: "apply_for",
    component: () => import("../views/apply_for.vue"),
  },
  {
    path: "/through",
    name: "through",
  ...
  },
  {
    path: "/money_road",
    name: "money_road",
    component: () => import("../views/money_road.vue"),
  },
  {
    path: "/my_commission",
    name: "my_commission",
    component: () => import("../views/my_commission.vue"),
  },
  {
    path: "/commission_subsidiary",
    name: "commission_subsidiary",
    component: () => import("../views/commission_subsidiary.vue"),
  },
  {
    path: "/walletmodel",
    name: "walletmodel",
    component: () => import("../views/walletmodel.vue"),
  },
  {
    path: "/newOrderPayment",
    name: "newOrderPayment",
    component: () => import("../views/newOrderPayment.vue"),
  },
  {
    path: "/Deposit",
    name: "Deposit",
  ...
  },
  {
    path: "/refundDetalis",
    name: "refundDetalis",
    component: () => import("../views/refundDetalis.vue"),
  },
  {
    path: "/refund",
    name: "refund",
  ...
  },
  {
    path: "/deta",
    name: "deta",
    component: () => import("../views/deta.vue"),
  },
  {
    path: "/completed",
    name: "completed",
  ...
  },
  {
    path: "/withdrala",
    name: "withdrala",
    component: () => import("../views/withdrala.vue"),
  },
  {
    path: "/withdrawal_success",
    name: "withdrawal_success",
    component: () => import("../views/withdrawal_success.vue"),
  },
  {
    path: "/newadd",
    name: "newadd",
  ...
  },
  {
    ...
    component: () => import("../views/confirm_couples.vue"),
  },
  {
    path: "/personmsg",
    name: "personmsg",
    component: () => import("../views/personmsg.vue"),
  },
  {
    path: "/authentication",
    name: "authentication",
  ...
  },
  {
    path: "/fenye",
    name: "fenye",
    component: () => import("../views/fenye.vue"),
  },
  {
    path: "/ShopHome",
    name: "ShopHome",
